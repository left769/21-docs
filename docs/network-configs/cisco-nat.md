...
```
Внутрішня мережа              Маршрутизатор             Інтернет
─────────────────────         ─────────────         ──────────────
PC-1: 172.16.0.10 ──┐         fa0/0 (inside)
PC-2: 172.16.0.20 ──┼──────►  172.16.0.1   ──NAT──  203.0.113.5  ──────► 8.8.8.8
PC-3: 172.16.0.30 ──┘         se0/0 (outside)
                               203.0.113.5
```
...
!!! tip "Яку різницю використовувати?"
